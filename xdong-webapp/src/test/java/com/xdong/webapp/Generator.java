...
public class Generator {
    ...
    public static void main(String[] args) {
        ...
        AutoGenerator mpg = new AutoGenerator()
                .setGlobalConfig(
                        // 全局配置
                        new GlobalConfig().setOutputDir("\\Users\\stone\\Downloads\\mybatis")// 输出目录
                ...
                .setDataSource(
                        ...
                        new DataSourceConfig().setDbType(DbType.MYSQL)// 数据库类型
                                ...
                                }).setDriverName("com.mysql.jdbc.Driver").setUsername("wanglei").setPassword("wanglei")
                                .setUrl("jdbc:mysql://localhost:3306/demo?useUnicode=true&characterEncoding=utf-8&zeroDateTimeBehavior=convertToNull"))
                .setStrategy(
                        // 策略配置
                        new StrategyConfig()
                                ...
                                .setInclude(new String[] { "sys_dept","sys_dict","sys_file","sys_log","sys_menu","sys_role","sys_role_menu","sys_task","sys_user","sys_user_role","blog_content","oa_notify","oa_notify_record","salary" }) // 需要生成的表
                ...
                .setPackageInfo(
                        // 包配置
                        new PackageConfig().setModuleName("module").setParent("com.xdong.dal.domain")// 自定义包路径
